...
class ImageProcessor {
    ...
    public static function processUpload($file) {
        ...
        return [
            ...
            'original_path' => 'uploads/originals/' . $originalName,
            'webp_path' => 'uploads/webp/' . $webpName,
            'thumb_path' => 'uploads/thumbnails/' . $thumbName,
            'small_path' => 'uploads/responsive/' . basename($smallPath),
            'medium_path' => 'uploads/responsive/' . basename($mediumPath),
            'large_path' => 'uploads/responsive/' . basename($largePath),
            'mime_type' => $mime,
            'width' => $width,
            'height' => $height,
