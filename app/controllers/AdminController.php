            ...
            if (!Security::verifyCsrfToken($_POST['csrf_token'] ?? '')) {
                ...
                if (!$processResult['status']) {
                    ...
                    $data = [
                        ...
                        ':filepath_small' => str_replace('public/', '', $processResult['small_path']),
                        ':filepath_medium' => str_replace('public/', '', $processResult['medium_path']),
                        ':filepath_large' => str_replace('public/', '', $processResult['large_path']),
